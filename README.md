...
using different amounts of clusters.</p>
<p>&emsp;K-means clustering, as implemented in the project, follows several steps. First, two 
...
location, and the algorithm has converged.</p>
<p>&emsp;An example of the K-means algorithm is shown in Figure 1. In this example, the clusters 
...
membership and find that there is no change. Thus, the algorithm has converged</p>
...
<img width="487" alt="image" src="https://user-images.githubusercontent.com/71890506/228024017-a7e7d2cc-7a15-47b5-b6ab-1d5dc1f6d7f4.png">

<br></br>

<p>&emsp;Once the algorithm has converged, a class label is assigned to each cluster. These labels 
...
cluster the new data is closest.</p>
<p>&emsp;Upon running the program, I came across an issue with clusters that did not have any 
...
trying to determine accuracies for specific clusters.<p/>
<p>&emsp;Two datasets will be used to test the accuracy of K-means clustering in generalizing to 
...
standard errors were graphed in Figure 2 and Figure 3.</p>
...
<img width="1080" alt="image" src="https://user-images.githubusercontent.com/71890506/228023917-15128770-2c7c-4690-8295-c8f8ff656c7b.png">
...
<img width="880" alt="image" src="https://user-images.githubusercontent.com/71890506/228023819-30ea8849-d5e1-4794-8295-b30191506c86.png">

<br></br>

<p>&emsp;Figure 2 shows the mean accuracy of the clustering for each number of clusters. The accuracy starts low when there is only one cluster. This quickly increases to where 
...
clusters (up to around seven) are not very good fits for the  data. The same is true for increasingly large numbers of clusters.</p>

<p>&emsp;Figure 3 shows the mean accuracy using the cancer dataset. There is a marked decrease 
...
<p>&emsp;K-means clustering can be seen to very accurately model data that is clearly grouped as 
...
<p>&emsp;To conclude, K-means clustering is very good at finding meaning from unclassified data 
...
modeling using unclassified data.</p>

<br></br>

<b>References</b>

Phillips, J. (2022). Unsupervised Learning. Lecture Notes.

Sakkaf, Y. (2020). Decision Trees: ID3 Algorithm Explained. https://towardsdatascience.com/decision-trees-for-classification-id3-algorithm-explained-89df76e72df1 

University of California Irvine (1988). Iris Data Set. https://archive.ics.uci.edu/ml/datasets/Iris 

University of California Irvine (2010). Breast Tissue Data Set. https://archive.ics.uci.edu/ml/datasets/Breast+Tissue
